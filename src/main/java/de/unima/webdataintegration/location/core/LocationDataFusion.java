...
public class LocationDataFusion {
	...
	public static void main(String[] args) throws XPathExpressionException, 
		...
		strategy.addAttributeFuser(Location.LATITUDE, new LatitudeFuserMedian(), new LatitudeEvaluationRule());
		strategy.addAttributeFuser(Location.LONGITUDE, new LongitudeFuserMedian(), new LongitudeEvaluationRule());
