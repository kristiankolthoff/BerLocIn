...
public class WebsiteFuserVoting extends AttributeValueFuser<String, Location, Attribute>{

	public WebsiteFuserVoting() {
		super(new Voting<>());
	}
