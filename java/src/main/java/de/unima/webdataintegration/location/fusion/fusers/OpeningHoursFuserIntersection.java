...
public class OpeningHoursFuserIntersection extends AttributeValueFuser<Set<OpeningHours>, Location, Attribute> {

	public OpeningHoursFuserIntersection() {
		super(new OpeningHoursIntersectionResolution());
	}
